...
public class chatFrame extends javax.swing.JFrame 
{
    ...
    String username,user, selectedUser, address = "localhost";
    ...
    public chatFrame(String Username, String SelectedUser) 
    {
        initComponents();
    ...
    private void btnPrescriptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrescriptionActionPerformed
        this.dispose();
        new givePrescription(username, selectedUser).setVisible(true);
    ...
    public static void main(String args[]) 
    {
        java.awt.EventQueue.invokeLater(new Runnable() 
        {
            ...
            public void run() 
            {
                new chatFrame("testingpatient", "doctor").setVisible(true);
            }
        });
    }
